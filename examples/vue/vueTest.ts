...
import {
    UWTChart, UWTCheckboxTree, UWTGrid, UWTPieChart, UWTSunburstChart, UWTFlowDiagram,
    UWTGraph, UWTHierarchyGraph
} from 'ui-widget-toolkit/framework/vue';

import UWTVue from 'ui-widget-toolkit/framework/vue';
Vue.use(UWTVue);

// Vue.component(UWTChart);
// Vue.component(UWTGrid);
// Vue.component(UWTPieChart);
// Vue.component(UWTSunburstChart);
// Vue.component(UWTFlowDiagram);
// Vue.component(UWTGraph);
// Vue.component(UWTHierarchyGraph);
// Vue.component(UWTCheckboxTree);

{
    ...
    let vm = new Vue({
        ...
        render: h => h(UWTChart, {
            props: {
                chartDef: chart, onRender: function () {
                    console.log('foo')
                }
            }
        })
...
let vm = new Vue({
    el: '#checkboxTree',
    render: h => h(UWTCheckboxTree, { props: { data: checkboxData } })
})
...

{
    ...
    new Vue({
        el: '#flowDiagram',
        render: h => h(UWTFlowDiagram, {
            props: {
                diagramTitle: 'Sankey Chart',
                diagramDef: flow,
                colorManager: TestBase.colorManager
            }
        })
...

{
    ...
    let flameChart = new Vue({
        el: '#flameChart',
        render: h => h(UWTChart, {
            props: {
                chartTitle: 'Flame Chart',
                chartDef: chart7,
                colorManager: TestBase.colorManager
            }
        })
    ...
    let sunburstChart = new Vue({
        el: '#sunburst',
        render: h => h(UWTSunburstChart, {
            props: {
...

{
    ...
    new Vue({
        el: '#hierarchyGraph',
        render: h => h(UWTHierarchyGraph, {
            props: {
                graphTitle: 'Hierarchy Graph',
                graphDef: graph,
                colorManager: TestBase.colorManager
            }
        })
