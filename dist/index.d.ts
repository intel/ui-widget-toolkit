...
export type ILayer = IXYLayer | ISummaryLayer | IMinMaxValueLayer | ITraceValueLayer | IStackLayer | IRectLayer | IMarkerLayer;
...
export class ElementManager implements UIElementManager {
        ...
        /**
            ...
            * @param the function to be called
            */
        setClickCallback(callback: (group: UIElement[], event: IEvent) => void): ElementManager;
        /**
            * user callback called when a tooltip is created
            *
            * @param the functiotn to be called
         ...
         * @return - The elem manager instance.
         */
        addToFocusGroup(elem: UIElement, groupName: string): ElementManager;
        /**
            * remove the elem from the zoom group it is in
            *
            * @param elem - the elem that should should be "unganged"
            ...
            * @return - The elem manager instance.
            */
        removeFromFocusGroup(elem: UIElement): ElementManager;
        /**
         * set the group to sync this elem with
         *
         * @param elem - the elem that should should be "ganged"
         ...
         * @return - The elem manager instance.
         */
        addToSelectGroup(elem: UIElement, groupName: string): ElementManager;
        /**
            * remove the elem from the zoom group it is in
            *
            * @param elem - the elem that should should be "unganged"
            ...
            * @return - The elem manager instance.
            */
        removeFromSelectGroup(elem: UIElement): ElementManager;
        /**
            * set the group to sync this elem with
            *
            * @param elem - the elem that should should be "ganged"
...
export function focus(d3Obj: d3.Selection<any, any, d3.BaseType, any>, fillColors: WeakMap<Object, string>, strokeColors: WeakMap<Object, string>): void;
export function unfocus(d3Obj: d3.Selection<any, any, d3.BaseType, any>, fillColors: WeakMap<Object, string>, strokeColors: WeakMap<Object, string>): void;
export function select(d3Obj: d3.Selection<any, any, d3.BaseType, any>, fillColors: WeakMap<Object, string>, strokeColors: WeakMap<Object, string>): void;
export function unselect(d3Obj: d3.Selection<any, any, d3.BaseType, any>, fillColors: WeakMap<Object, string>, strokeColors: WeakMap<Object, string>): void;
export function onSelectHelper(caller: UIElement, value: any, selectionValue: string): void;
export function addClickHelper(target: d3.Selection<d3.BaseType, any, d3.BaseType, any>, options: IOptions, onClick: (event: IEvent) => void, onDoubleClick: (event: IEvent) => void, contextMenuItems: IContextMenuItem[], tooltip: BaseTooltip, caller: UIElement, value?: any, selectionValue?: string): void;
...
export class FlameChartSeries extends BaseSeries implements ICartesianSeriesPlugin {
        ...
        protected getEventDataValue(value: IFlameChartValue): ITraceValue | ITraceValue[];
        constructor(chart: ID3Chart, layer: ILayer, svg: d3.Selection<d3.BaseType, {}, d3.BaseType, any>, xAxis: D3Axis, yAxis: D3Axis, isXContinuous: boolean);
        setData(layer: ILayer): void;
        ...
        protected configureSegmentInteraction(elem: d3.Selection<d3.BaseType, {}, d3.BaseType, any>, value?: IFlameChartValue): void;
...
export class InteractionState {
    ...
    constructor(focus: (d: any) => void, unfocus: (d: any) => void, doBlink?: boolean, select?: (d: any) => void, unselect?: (d: any) => void);
    static getFocusColor(input: string): string;
    /** add a selection from all of the elements */
    protected _addFocusHelper(selection: any): void;
    /** remove a selection from all of the elements */
    protected _unfocusHelper(selection: any, isFlashing?: boolean): void;
    /** add a selection from all of the elements */
    protected _addSelectionHelper(selection: any): void;
    /** remove a selection from all of the elements */
    protected _removeSelectionHelper(selection: any, isFlashing?: boolean): void;
    focus(event: IEvent): void;
    select(event: IEvent): void;
...
export let SelectionHelper: typeof InteractionState;
...
export class BaseSeries {
        ...
        protected initializeContextMenuItems(): void;
        protected applyStyles(): void;
        getMaxNameLength(): number;
        /** check if the x is continuous series */
        isXContinuousSeries(): boolean;
        ...
        protected clickCallback(value: any, callback: (event: IEvent) => void): (event: IEvent) => void;
        protected onClick(value: any): (event: IEvent) => void;
        protected onDoubleClick(value: any): (event: IEvent) => void;
        /** lambda function to wrap shared click execution flows */
        protected clickExecute(value: any, selectionValue: string): void;
        /** this adds some logic since the brush is behind rendered elements so
            ...
            */
        protected configureItemInteraction(elem: d3.Selection<d3.BaseType, {}, d3.BaseType, any>, value: any, selectionValue: string): void;
        protected configureBandedItemInteration(elem: d3.Selection<d3.BaseType, {}, d3.BaseType, any>, value: any, selectionValue: string): void;
        /** this adds some logic since the brush is behind the elements we need to
            ...
            */
        protected configureItemInteractionPIXI(elem: any, value: any, selectionValue: string): void;
        clear(): void;
}
...
export class PIXIHelper {
    ...
    createRectange(width: number, height: number, backgroundColor: number): PIXI.Sprite;
    ...
    addInteractionHelper(target: PIXI.DisplayObject, options: IOptions, onClick: (event: IEvent) => void, onDoubleClick: (event: IEvent) => void, contextMenuItems: IContextMenuItem[], hoverStart: (event: IEvent) => void, hoverEnd: (event: IEvent) => void, tooltip: BaseTooltip, caller: UIElement, value: any, selectionValue: any): void;
...
export class D3Polar extends SVGRenderer {
        ...
        /** configures segment hover and stores the current hovered
            ...
            **/
        protected configureItemInteraction(target: d3.Selection<d3.BaseType, any, d3.BaseType, any>, value: any, selectionValue: string): void;
...
export class D3ConnectedGraphSVG extends SVGRenderer {
        ...
        protected getHeightWidth(options: IOptions): void;
