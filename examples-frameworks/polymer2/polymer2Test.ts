...
module PolymerTest {
    window.onload = () => {
...

        {
            ...
            let swimlaneDefs = [swimChart];
            let swimlaneDiv: any = document.getElementById('swimlaneTest');
            swimlaneDiv['chartTitle'] = 'Swimlane Test';
            swimlaneDiv['chartDefs'] = swimlaneDefs;
            swimlaneDiv['colorManager'] = TestBase.colorManager;

            // test dynamic adding of data to swimlanes
            setTimeout(function () {
                swimlaneDefs.push(swimChart2);
                swimlaneDiv._onDataChanged();
                setTimeout(function () {
                    swimlaneDefs.push(swimChart3);
                    swimlaneDiv._onDataChanged();
                    setTimeout(function () {
                        swimlaneDefs.splice(0, 1);
                        swimlaneDiv._onDataChanged();
                        setTimeout(function () {
                            swimlaneDefs.push(swimChart);
                            swimlaneDiv._onDataChanged();
                        }, 0);
                    }, 0);
                }, 0);
            ...
            div['chartDef'] = chart;
            div['renderOptions'] = optionsBigLaneBlink;
            ...
            let chart4: UWT.ICartesianChart = {
                ...
                dataSets: [{
                    ...
                    data: [{ key: '', data: { 'data-0': 123, 'data-1': 32, 'data-2': 88 } }]
                }],
                isXContinuous: false
            }
            ...
            div4['chartDef'] = chart4;

            let chart5: UWT.ICartesianChart = {
                type: UWT.UIType.Cartesian,
                dataSets: [{
                    renderType: UWT.RenderType.Bar,
                    data: [{ key: 'data-0', data: { 'tony': 123, 'jak': 32, 'michelle': 88 } },
                    { key: 'data-1', data: { 'tony': 23, 'jak': 65, 'michelle': 124 } },
                    { key: 'data-2', data: { 'tony': 54, 'jak': 21, 'michelle': 13 } }],
                    colors: { 'tony': 'red', 'jak': 'green', 'michelle': 'blue' }
                }],
            ...
            div5['chartDef'] = chart5;

            let chart6: UWT.ICartesianChart = {
                type: UWT.UIType.Cartesian,
                dataSets: [{
        ...
        {
            let div: any = document.getElementById('pieTestId');
            div['chartTitle'] = 'Test Chart';
            ...
            div2['chartTitle'] = 'Test Chart 2';

            let pieDef2: UWT.IPieChart = {
                type: UWT.UIType.Pie,
        ...
        {
            let div: any = document.getElementById('flowchart1');
            div['diagramTitle'] = 'Sankey Diagram';
        ...
        {
            let div: any = document.getElementById('forcegraph1');
            div['graphTitle'] = 'Force Graph';
        ...
        }
        {
            ...
            let div2: any = document.getElementById('radar');
            div2['title'] = 'Radar Chart';
            div2['chartDef'] = radar1;
        }
    }
};