...

{
    ...
    TestBase.addElement(force, 'group1', 'group1');
    ...
    TestBase.addElement(flame);
    TestBase.elemManager.addToHighlightGroup(flame, 'trace');


    let sunburst: UWT.ISunburstChart = {
    ...
    let hGraph: UWT.IHierarchyGraph = {
        links: links,
        nodes: root,
