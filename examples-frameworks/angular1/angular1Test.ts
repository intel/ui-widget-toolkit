...
module AngularTest {
    ...
    var app = angular.module('test', ['ui-widget-toolkit']);
    app.controller('TestCtrl', function ($scope: any, $window: any) {
        ...
        $scope.swimTitle = 'Swimlane Test';
        $scope.swimDef = swimlaneDefs;
        $scope.swimlaneOptions = options;
        ...
        {
            $scope.flowTitle = 'Sankey Diagram';
            ...
            $scope.diagramDef = flow;
            $scope.colorManager = TestBase.colorManager;
        }

        {
            $scope.graphTitle = 'Force Graph';
...

        {
            ...
            $scope.flameTitle = 'Flame Chart';
            $scope.flameChart = chart7;
            $scope.flameRenderOptions = optionsFlame;
